        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 shadow-xl">
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-red-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-lg px-4 py-2.5 text-sm transition-colors mt-2"
            >
